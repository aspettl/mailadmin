...
json.mailbox_aliases Hash[@local_mailboxes.filter{ |account| account.forward }.map{ |account| [ account.email, account.forward_to ] }]
json.mailbox_aliases Hash[@alias_addresses.map{ |account| [ account.email, account.alias_target ] }]
