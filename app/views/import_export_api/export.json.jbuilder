...
json.mailbox_aliases Hash[@local_mailboxes.filter{ |account| account.forward }.map{ |account| [ account.email, account.forward_to ] } + @alias_addresses.map{ |account| [ account.email, account.alias_target ] }]
